...
#---------------
=begin
  def define_dijkstra_command
    default_command :dijkstra
    desc 'Displays topology information (text mode)'
    command :dijkstra do |cmd|
      cmd.action(&method(:create_dijkstra_view))
    end
  end
=end
#---------------
...
#---------------
=begin
	def create_dijkstra_view(_global_options, _options, _args)
		@view = View::Dijkstra.new
	end
=end
#---------------
